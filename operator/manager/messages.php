...
$query = "SELECT * FROM Messages LEFT JOIN Operators USING(operator_id) ORDER BY time";
...
<tr><td bgcolor=navy><FONT class=a1 color=#ffffff>&nbsp;<B><? print TEXT_LOGS ?></B></FONT></td>
<tr><td class=WIN>
