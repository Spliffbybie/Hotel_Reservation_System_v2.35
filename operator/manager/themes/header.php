  ...
  <TR>
        ...
        <TR>
          <TD align=center>
            <TABLE cellSpacing=0 cellPadding=0 bgColor=#c0c0c0 border=0  width=815 align=center>
              ...
              <TR>
		<TD width="80" align=center valign=top>&nbsp;<a href=index.php  class=top><? print TEXT_MANAGER_SECTION ?></a>&nbsp;</TD>
   ...
   <TD 
              style="BORDER-RIGHT: 0px; BORDER-TOP: 0px; BORDER-LEFT: 0px; BORDER-BOTTOM: 0px" 
                bgColor=#FFE0AD border="0" cellpadding="0"  cellspacing="0" width=200 valign=top>

 <TABLE cellSpacing=5 width=150 border=0 valign=top>
  <TR>
    <TD onmouseover="this.style.backgroundColor='maroon'" 
    onmouseout="this.style.backgroundColor='FFE0AD'" ><a href="settings.php" class=menu><? print TEXT_SETTINGS ?></a></TD>
  </TR>
  <TR>
    <TD onmouseover="this.style.backgroundColor='maroon'" onmouseout="this.style.backgroundColor='FFE0AD'" >
    <a href="operators.php" class=menu><? print TEXT_OPERATORS ?></a></TD>
  </TR>
  <TR>
    <TD onmouseover="this.style.backgroundColor='maroon'" 
    onmouseout="this.style.backgroundColor='FFE0AD'" ><a href="messages.php" class=menu><? print TEXT_LOGS ?></a></TD>
  </TR>
  <TR>
    <TD onmouseover="this.style.backgroundColor='maroon'" 
    onmouseout="this.style.backgroundColor='FFE0AD'" >	<a href="statistic.php" class=menu><? print TEXT_STAT ?></a></TD>
  </TR>
 <TR>
    <TD onmouseover="this.style.backgroundColor='maroon'" onmouseout="this.style.backgroundColor='FFE0AD'"><a href="reservations_delete.php" class=menu><? print TEXT_DEL_RESERV ?></a></TD>
 </TR>			
<TR>
    <TD onmouseover="this.style.backgroundColor='maroon'" onmouseout="this.style.backgroundColor='FFE0AD'"><a href="pages.php" class=menu><? print TEXT_PAGES ?></a></TD>
 </TR>			
 </TABLE>
